...
import com.gultendogan.runningapp.services.Polylines
...
const val CANCEL_TRAKING_DIALOG_TAG = "CancelDialog"
...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            val cancelTrackingDialog = parentFragmentManager.findFragmentByTag(
                CANCEL_TRAKING_DIALOG_TAG) as CancelTrackingDialog?
    ...
    private fun showCancelTrackingDialog() {
        ...
        }.show(parentFragmentManager, CANCEL_TRAKING_DIALOG_TAG)
    }
